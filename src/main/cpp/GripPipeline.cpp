...
void GripPipeline::Process(cv::Mat& source0){
	...
	double resizeImageWidth = 630.0;  // default Double
	...
	double hsvThresholdHue[] = {51.798561151079134, 97.06484641638228};
	double hsvThresholdSaturation[] = {66.50179856115108, 170.14505119453926};
	double hsvThresholdValue[] = {103.1924460431655, 255.0};
