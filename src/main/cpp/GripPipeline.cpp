...
void GripPipeline::Process(cv::Mat& source0){
	...
	double hsvThresholdHue[] = {58.273381294964025, 147.74744027303757};
	double hsvThresholdSaturation[] = {75.67446043165468, 222.36348122866895};
	double hsvThresholdValue[] = {178.86690647482015, 255.0};
